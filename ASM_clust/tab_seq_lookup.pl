...
# A script to extract sequences that have BLAST/DIAMOND/MMseqs2 hits against a custom database
# for use with the ASM_clust.sh shell script, but can be used as standalone script as well
...
# in case you put this script in a pipeline which has to deal with both fasta and fastq files, determine filetype
my $file_type;
